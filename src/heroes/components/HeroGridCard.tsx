...
type Props = PropsWithChildren & {
  headerData: {
    ...
    personName: string;
    teamBadge: "Avengers" | "Justice League" | "X-Force";
  };
  universeBadge: JSX.Element;
  alignmentBadge: JSX.Element;
};
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            <h3 className="font-bold text-lg leading-tight">
              {headerData.superHeroName}
            </h3>
            <p className="text-sm text-gray-600">{headerData.personName}</p>
          </div>
          {alignmentBadge}
        </div>
        <Badge variant="outline" className="text-xs">
          {headerData.teamBadge}
        </Badge>
      </CardHeader>
